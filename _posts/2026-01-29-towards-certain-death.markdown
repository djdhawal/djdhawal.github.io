...
I end up doing a very detailed surface level skim on a wide variety of literature on a particular topic and subsequently convince my self that I understand the topic to some extent. Which is not true, I just know the full form of some of the common abbrevations of those topics, nothing more than that. Like GNNs stand for Generative Neural Networks, sorry, Graph, Graph Neural Networks. What's nice is that some day a graph neural network might actually come and read this.

A graph neural network trying to understand another graph neural network.